...
public class SoftSprite : MonoBehaviour
{
	...
	private void UpdateMesh()
	{
		...
		for (int y = 0, i = 0; y <= jointsVerticalCount; y++)
		{
			...
			{
				vertices[i] = new Vector3(size.x * x / (float)jointsHorizontalCount, size.y * y / (float)jointsVerticalCount, 0) - offset;
	...
	private void UpdateMaterialTexture(Texture texture)
	{
		CreateSpriteMaterial();
