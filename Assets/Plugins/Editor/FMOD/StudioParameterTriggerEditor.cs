...
namespace FMODUnity
{
    ...
    public class StudioParameterTriggerEditor : Editor
    {
        ...
        private SerializedProperty ResetAfterPlay;
        ...
        void OnEnable()
        {
            ...
            ResetAfterPlay = serializedObject.FindProperty("ResetAfterPlay");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(ResetAfterPlay, new GUIContent("ResetAfterPlay"));
            EditorGUILayout.PropertyField(ResetTime, new GUIContent("ResetTime"));
